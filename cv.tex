...
\begin{itemize}[leftmargin=0.5cm]
    ...
    \item \textbf{Bangkok Bank} \\
          ...
          \textit{Tech Stack:} ReactJS, Microsoft Power Platform, Microsoft Dynamics 365 \\
          \textit{Highlights:}
          \begin{itemize}[leftmargin=0.5cm, noitemsep, topsep=0pt]
              \item Built reusable and customizable UI components as custom control components
          \end{itemize}
\end{itemize}
